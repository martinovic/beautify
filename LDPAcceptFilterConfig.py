...
#        self.yesno_answer      = ['no', 'yes']
        ...
        self.Add('EditWindow', 'dialog', self['parent'].frame,
            _value=language['Spanish']['accept_filter'],
        ...
        self.Add('chkAccept', 'check', 'EditWindow',
            _value=language['Spanish']['accept'])

        self['EditWindow']['chkAccept'].SetValue(bool(
            self.truefalse_answer.index(
            self.filter.get('accept', 'true'))))
        ...
        if self['EditWindow'].frame.ShowModal() == wx.ID_OK:
            ...
            attrs.update({ 'prefix': self['EditWindow']['txtPrefix'].GetValue(), 
                            ...
                            'accept': self.truefalse_answer[int(
                                self['EditWindow']['chkAccept'].GetValue())]})
            self.api.command(Execution(' / mpls / ldp / accept - filter / %s' % cmd,
